        ...
        <div className="about__container container grid">
            ...
            <div className="about_data">
                ...
                <p className="about__description"> Je suis actuellement étudiant en informatique et je suis une
                                                    passionné par ce domaine. J'adore apprendre de nouvelles
                                                    technologies et comprendre comment les utiliser pour
                                                    résoudre des problèmes complexes. Je suis également très
                                                    intéressé par la programmation et j'aime développer des
                                                    outils qui peuvent faciliter la vie des gens. Pour continuer à
                                                    développer mes compétences et mettre en pratique ce que
